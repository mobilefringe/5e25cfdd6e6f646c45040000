            ...
            computed: {
                ...
                featuredItems() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de7dca36e6f6435b2020000/image/png/1529532181000/promoplaceholder2@2x.png";
                            }
                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de7dca36e6f6435b2020000/image/png/1529532187000/eventsplaceholder2@2x.png";
                            }
                ...
                loadData: async function() {
                    try {
                        let results = await Promise.all(
                            ...
                            this.$store.dispatch('LOAD_PAGE_DATA', { url: "https://" + siteInfo.subdomain + ".mallmaverick.com/api/v4/" + siteInfo.subdomain +"/social.json" })
                        ]);
                        return results;
                    } catch(e) {
